...
variable "cluster_name" {
  ...
  type        = string
  default     = "chaitanya-cluster"
}

variable "vpc_id" {
  description = "Existing VPC containing the EKS subnets."
  type        = string
  default     = "vpc-06e504d30afc7440e"
}
...
variable "subnet_ids" {
  ...
  default = [
    "subnet-0dfd3dd9e37b85026",
    "subnet-00e25a111a7833393",
    "subnet-04ff6aebbae9df70c"
  ]
...
resource "aws_eks_cluster" "main" {
  ...
  lifecycle {
    precondition {
      ...
      error_message = "Every subnet must belong to the specified VPC."
    }
    ...
    precondition {
      ...
      error_message = "The selected subnets must span at least two Availability Zones."
    }
  }
}
...
resource "aws_eks_node_group" "main" {
  ...
  lifecycle {
    precondition {
      ...
      error_message = "Desired node count must be between minimum and maximum node count."
    }
  }
}
